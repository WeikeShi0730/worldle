...
const Selections = () => {
  ...
  return (
    <>
      <div className="w-full flex justify-evenly items-center max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg m-auto my-5 rounded shadow-md hover:shadow-gray-400 transform duration-200 ease-in-out">
        <Select
