    ...
    <>
      ...
      {game === IN_PROCESS ? (
        <button
          ...
          className="flex justify-center items-center w-40 m-auto p-2 my-5 bg-white rounded shadow-sm hover:shadow-md hover:shadow-gray-400 transform duration-200 ease-in-out"
        >
          Submit
        </button>
      ) : (
